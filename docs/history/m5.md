...
The work of M5 was partitioned by bay into M5.1–M5.9, followed by cross-cutting concerns (M5.10–M5.13, the keyboard joining them on 2026-09-05) and by M5.14, which was cut later for work no bay could hold. Two sections carry rows no bay owns — *Rows the manual has not given a home* and *The console's own shape* — and ADR-0226 closes M5 only with them.
