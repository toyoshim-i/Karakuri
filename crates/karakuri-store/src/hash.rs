//! Content addressing for stored artifacts.
//!
//! An artifact is uniquely identified by the SHA-256 hash of its canonical `.kir` source code.
//! Dynamic parameters such as buffer capacity are not part of procedure identity.
