...
/// - If line 0 is a `Record::Header` with a different version, replaces it with
///   `CURRENT_SCHEMA_VERSION` and preserves the rest of the lines.
/// - If line 0 is not a header, prepends `Record::Header { version:
