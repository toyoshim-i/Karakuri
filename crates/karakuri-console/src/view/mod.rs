...
/// already writes `view::outputs` or `view::Outputs` has to learn a second
/// path for it.
pub use outputs::*;
...
pub(crate) use widgets::{
    bank_capsules, folded_head_into, grip_dots, head_box, head_capsule, head_grip, head_into,
    head_pills, on_pill_at, pane_dividers, pill_at, pill_into, pill_width, spaced, ARMED_GLOW,
    ARMED_WASH, ON_GLOW, ON_WASH,
};
