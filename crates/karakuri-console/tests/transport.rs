...
/// the seam this crate is built on read from the test's end. Containment rather
/// than intersection so that the panel's ground and the card's drop shadow —
/// both larger than the row — are not counted as things drawn in it.
///
