...
fn the_press_handler_dispatches_inspector_slot_mcp_pill() {
    ...
    readout.panel.solve();
    assert_eq!(
        readout.view.slot_policies[0],
        karakuri_operation::SlotPolicy::Auto
    );
    assert_eq!(
        readout.slot_policies.policy(0),
        karakuri_operation::SlotPolicy::Auto
    );
    ...
    assert_eq!(
        readout.view.slot_policies[0],
        karakuri_operation::SlotPolicy::On
    );
    assert_eq!(
        readout.slot_policies.policy(0),
        karakuri_operation::SlotPolicy::On
    ...
    assert_eq!(
        readout.view.slot_policies[0],
        karakuri_operation::SlotPolicy::Off
    );
    assert_eq!(
        readout.slot_policies.policy(0),
        karakuri_operation::SlotPolicy::Off
